...
export default function PaginationComp({
  ...
  const firstLastAndDotsBtns = 4;
  const oneDotAndOneFirstOrLastBtn = 2;
  const btnsInMiddlePaginationRange = siblingsPairForMiddlePoint * 2 + 1;
  const maxPageBtns = firstLastAndDotsBtns + btnsInMiddlePaginationRange;
  const btnsInSubPaginationRange = maxPageBtns - oneDotAndOneFirstOrLastBtn;
  ...
  useEffect(() => {
    if (totalPages <= maxPageBtns) {
      ...
      if (activePage <= btnsInSubPaginationRange - 1) {
        ...
        activePage > Number(paginationRange[2]) &&
          ...
          <button
            ...
            onClick={() =>
              item === "..." && i === 1
                ...
                : item === "..." && i === paginationRange.length - 1
